;; ====================================================================
;; SISTEMA EXPERTO V5 PARA IDENTIFICACIÓN DE ANIMALES
;; ====================================================================
...
;; - Más animales en la base de conocimientos
;;
...
;; Función para calcular el porcentaje de coincidencia ponderado (V5)
...
(defun formatear-pregunta (caracteristica)
  ...
  (case caracteristica
    ...
    (hace-sonido "Qué sonido hace el animal (ladrido/maullido/relincha/rugido/trompeta/chillido/aulla/muuu/beee/grunido/cacarea/oink)")
...
(defun sistema-experto ()
  "Sistema experto principal con ponderación V5"
  (format t "~%============================================~%")
  (format t "  SISTEMA EXPERTO V5 - IDENTIFICACIÓN~%")
  ...
  (format t "  - Más animales en la base~%")
...
(defun demo-automatica ()
  "Demostración automática con ponderación V5 y grado de confiabilidad"
  (format t "~%=== DEMOSTRACIÓN AUTOMÁTICA V5 CON PONDERACIÓN ===~%~%")
  ...
  ;; Ejemplo 5: Nuevo animal (Lobo)
  (format t "Ejemplo 5: Nuevo animal (Lobo)~%")
  (setf *hechos* '((hace-sonido aulla)
                  (tiene-pelo si)
                  (tamaño mediano)
                  (es-carnivoro si)
                  (vive-en-tierra si)
                  ...
                  (numero-patas 4)))
  (let ((candidatos (identificar-animales-con-porcentaje-ponderado)))
    (format t "Hechos: hace-sonido=aulla, tiene-pelo=si, tamaño=mediano, es-carnivoro=si, vive-en-tierra=si, vive-en-agua=no, tiene-patas=si, numero-patas=4~%")
    (format t "Candidato principal: ~a - ~,2f%% | Grado: ~a~%"
            (string-upcase (caar candidatos))
            (cadar candidatos)
            (grado-confiabilidad (cadar candidatos)))
  ...
  ;; Ejemplo 6: Nuevo animal (Gallina)
  (format t "Ejemplo 6: Nuevo animal (Gallina)~%")
  (setf *hechos* '((hace-sonido cacarea)
                  (tiene-plumas si)
                  (puede-volar no)
                  (tiene-patas si)
                  (numero-patas 2)
                  ...
                  (pone-huevos si)))
  (let ((candidatos (identificar-animales-con-porcentaje-ponderado)))
    (format t "Hechos: hace-sonido=cacarea, tiene-plumas=si, puede-volar=no, tiene-patas=si, numero-patas=2, vive-en-agua=no, pone-huevos=si~%")
    (format t "Candidato principal: ~a - ~,2f%% | Grado: ~a~%"
            (string-upcase (caar candidatos))
            (cadar candidatos)
            (grado-confiabilidad (cadar candidatos)))
  ...
  ;; Ejemplo 7: Detección de incompatibilidad
  (format t "Ejemplo 7: Detección de incompatibilidad~%")
